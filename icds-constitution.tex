...
\begin{enumerate}[resume]
    \item The society aims to:
        \begin{enumerate}
            ...
            \item promote the furtherance of its Members' technical experience in the fields of design and engineering for theatre and other live events.
        \end{enumerate}
    \item The society, as managed by the Committee, shall strive to achieve these objectives as its commitment to its membership. 
\end{enumerate}
...
\begin{enumerate}[resume]
    ...
    \item A position of office may be vacated by: \begin{enumerate}
            \item Resignation
            \item End of term of office
            \item Failure to hold full membership of the Society
            \item Death
        \end{enumerate}
...
\begin{enumerate}[resume]
    ...
    \item An archive of all meeting minutes should be made publicly available by the secretary, except where those minutes relate to any reserved or confidential matters, including without limitation staff-related or disciplinary matters.
...
\begin{enumerate}[resume]
    ...
    \item \newthought{The Treasurer:}
        \begin{enumerate}
            ...
            \item shall ensure that an appropriately-qualified person (usually the Producer) of every show produced by the Society keeps appropriate accounts for the show.
    ...
    \item \newthought{The Honorary Secretary:}
        \begin{enumerate}
            \item shall be responsible for minuting all meetings of the society and maintaining a public archive of them.
    ...
    \item \newthought{The Technical Director:}
        \begin{enumerate}
            ...
            \item shall be assisted in these aims by the Lighting Director, the Sound Director and the Set, Props and Costumes Director as described below.
        \end{enumerate}
    ...
    \item \newthought{The Pub. Officer:}
        \begin{enumerate}
            ...
            \item shall be responsible for the design of the Society's publicity materials and shall maintain a coherent consistent brand image for the Society.
